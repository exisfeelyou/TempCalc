...
class ThermalReactor:
    def __init__(self):
        ...
        self.MAX_DEVIATION = BPRT_MAX_DEVIATION
...
async def start_bprt_conversation(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
async def handle_bprt_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
